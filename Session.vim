...
if &buftype ==# 'terminal'
  silent file colors/handmade.vim
endif
balt todo-comments.lua
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists(fnamemodify("C:/dev/handmade/code/handmade.cpp", ":p")) | buffer C:/dev/handmade/code/handmade.cpp | else | edit C:/dev/handmade/code/handmade.cpp | endif
if &buftype ==# 'terminal'
  silent file C:/dev/handmade/code/handmade.cpp
endif
balt C:/dev/handmade/code/handmade_platform.h
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
